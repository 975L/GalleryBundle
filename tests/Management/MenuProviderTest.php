...
class MenuProviderTest extends TestCase
{
    ...
    // Only the photo CRUD is listed - category management is reachable from its toolbar instead
    // (see GalleryPhotoCrudController), so the two screens read as one linked feature
