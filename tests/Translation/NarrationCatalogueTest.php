...
{
    // The bundle's own narrations, resolved in its "gallery" domain suffixed "_narration" - spoken and never drawn, and shipped in every locale the rest of the bundle speaks
