...
class SkillsTest extends TestCase
{
    ...
    private const string SLUG_PATTERN = '#^(gallery|theme-color-gallery)-[a-z-]+$#';

    private const string NAME_PATTERN = '#^[a-z][a-z0-9]*(_[a-z0-9]+)+(\([^)]*\))?$#';

    private const string COMMAND_PATTERN = '/c975l:gallery:[a-z-:]+/';

    private const string COMPONENT_PATTERN = '/<twig:c975LGallery:([A-Za-z:]+)/';
