...
// Mirrors UiBundle's own BlockUserListener - kept separate rather than shared since UiBundle must stay standalone (it can't reference this bundle's GalleryPhoto entity). Tracks who last touched the photo, not who originally uploaded it - $user is overwritten on every save (see preUpdate below)
